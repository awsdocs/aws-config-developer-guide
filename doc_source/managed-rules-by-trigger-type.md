# List of AWS Config Managed Rules by Trigger Type<a name="managed-rules-by-trigger-type"></a>
...
## Configuration Changes<a name="configuration-changes-section-head"></a>

*Change\-triggered rules* are rules that AWS Config evaluates in response to configuration changes\.

### Configuration Changes<a name="configuration-changes"></a>
...
## Periodic<a name="periodic-section-head"></a>
...
## Hybrid<a name="hybrid-section-head"></a>
