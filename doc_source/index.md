...
+ [What Is AWS Config?](WhatIsConfig.md)
   ...
   + [AWS Config Supported AWS Resource Types and Resource Relationships](resource-config-reference.md)
...
+ [Controlling Permissions for AWS Config](example-policies.md)
...
+ [Evaluating Resources with Rules](evaluate-config.md)
...
+ [Using AWS Config with Interface VPC Endpoints](config-VPC-endpoints.md)
