...
+ [Evaluating Resources with AWS Config Rules](evaluate-config.md)
   ...
   + [AWS Config Managed Rules](evaluate-config_use-managed-rules.md)
      + [List of AWS Config Managed Rules](managed-rules-by-aws-config.md)
         ...
         + [elasticache-redis-cluster-auto-backup-check](elasticache-redis-cluster-auto-backup-check.md)
         ...
         + [fms-security-groups-audit-policy-check](fms-security-groups-audit-policy-check.md)
         + [fms-security-groups-content-check](fms-security-groups-content-check.md)
         + [fms-security-groups-resource-association-check](fms-security-groups-resource-association-check.md)
