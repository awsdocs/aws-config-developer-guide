...
Checks whether S3 buckets have policies that require requests to use Secure Socket Layer \(SSL\)\. The rule is COMPLIANT if buckets explicitly deny access to HTTP requests\. The rule is NON\_COMPLIANT if bucket policies allow HTTPS requests\.
...
## AWS CloudFormation template<a name="w24aac11c29c17d321c23"></a>
