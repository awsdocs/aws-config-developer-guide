...
| --- | --- | --- | 
|  [AWSConfigServiceRolePolicy](#security-iam-awsmanpol-AWSConfigServiceRolePolicy) – Add detective:ListGraphs, detective:ListTagsForResource, ram:GetResourceShares, ram:GetResourceShareAssociations, glue:ListCrawlers, glue:ListMembers, glue:GetMembers, guardduty:GetThreatIntelSet, guardduty:ListThreatIntelSets, guardduty:GetIPSet, guardduty:ListIPSets, guardduty:ListTagsForResource, guardduty:GetFilter, guardduty:ListFilters, sso:DescribeInstanceAccessControlAttributeConfiguration, sso:DescribePermissionSet, sso:ListTagsForResource, sso:ListPermissionSets, sso:ListManagedPoliciesInPermissionSet, ses:GetConfigurationSet, ses:GetConfigurationSetEventDestinations, ses:ListConfigurationSets, macie:GetMacieSession, glue:BatchGetDevEndpoints, glue:GetDevEndpoint, glue:GetDevEndpoints, glue:ListDevEndpoints, glue:ListWorkflows, glue:GetSecurityConfiguration, glue:GetSecurityConfigurations, glue:GetTags, glue:ListJobs, glue:GetWorkGroup, glue:ListWorkGroups, athena:GetDataCatalog, athena:ListTagsForResource, and athena:ListDataCatalogs  |   This policy grants permission to get a list of behavior graphs, list tags for a behavior graph, retrieve details about the resource shares, retrieve the resource and principal associations for resource shares, retrieve the names of all crawler resources in this AWS account, get details about member accounts, retrieve GuardDuty member accounts, retrieve a GuardDuty ThreatIntelSet, get the ThreatIntelSets of the GuardDuty service, retrieve a GuardDuty IPSet, get the IPSets of the GuardDuty service, retrieve tags for Guardduty Service, retrieve details about a GuardDuty, get a list of GuardDuty Filters, get a list of AWS SSO identity store attributes, get the details of the permission set, get tags for SSO resources, get the permissions set for SSO instance, get IAM managed policy that is attached to a specified permission set, get information about an existing configuration set, get a list of event destinations that are associated with a configuration set, list all of the configuration sets associated with your account, get the current status and configuration settings for an Amazon Macie, get a list of resource metadata for a given list of development endpoint names, get information about a specified development endpoint, get all the development endpoints in this AWS account, get the names of all DevEndpoint resources in this AWS account, list names of workflows created in the account, get retrieves a specified security configuration, get all glue security configurations, get a list of tags associated with a resource, list the names of all job resources in this AWS account, get information about the workgroup with the specified name, list available workgroups for the account, get the specified data catalog, list tags associated with an Athena workgroup or data catalog resource, and list the data catalogs in the current AWS account\.  | May 31, 2022 | 
|  [AWS\_ConfigRole](#security-iam-awsmanpol-AWS_ConfigRole) – Add detective:ListGraphs, detective:ListTagsForResource, ram:GetResourceShares, ram:GetResourceShareAssociations, glue:ListCrawlers, glue:ListMembers, glue:GetMembers, guardduty:GetThreatIntelSet, guardduty:ListThreatIntelSets, guardduty:GetIPSet, guardduty:ListIPSets, guardduty:ListTagsForResource, guardduty:GetFilter, guardduty:ListFilters, sso:DescribeInstanceAccessControlAttributeConfiguration, sso:DescribePermissionSet, sso:ListTagsForResource, sso:ListPermissionSets, sso:ListManagedPoliciesInPermissionSet, ses:GetConfigurationSet, ses:GetConfigurationSetEventDestinations, ses:ListConfigurationSets, macie:GetMacieSession, glue:BatchGetDevEndpoints, glue:GetDevEndpoint, glue:GetDevEndpoints, glue:ListDevEndpoints, glue:ListWorkflows, glue:GetSecurityConfiguration, glue:GetSecurityConfigurations, glue:GetTags, glue:ListJobs, glue:GetWorkGroup, glue:ListWorkGroups, athena:GetDataCatalog, athena:ListTagsForResource, and athena:ListDataCatalogs  |   This policy grants permission to get a list of behavior graphs, list tags for a behavior graph, retrieve details about the resource shares, retrieve the resource and principal associations for resource shares, retrieve the names of all crawler resources in this AWS account, get details about member accounts, retrieve GuardDuty member accounts, retrieve a GuardDuty ThreatIntelSet, get the ThreatIntelSets of the GuardDuty service, retrieve a GuardDuty IPSet, get the IPSets of the GuardDuty service, retrieve tags for Guardduty Service, retrieve details about a GuardDuty, get a list of GuardDuty Filters, get a list of AWS SSO identity store attributes, get the details of the permission set, get tags for SSO resources, get the permissions set for SSO instance, get IAM managed policy that is attached to a specified permission set, get information about an existing configuration set, get a list of event destinations that are associated with a configuration set, list all of the configuration sets associated with your account, get the current status and configuration settings for an Amazon Macie, get a list of resource metadata for a given list of development endpoint names, get information about a specified development endpoint, get all the development endpoints in this AWS account, get the names of all DevEndpoint resources in this AWS account, list names of workflows created in the account, get retrieves a specified security configuration, get all glue security configurations, get a list of tags associated with a resource, list the names of all job resources in this AWS account, get information about the workgroup with the specified name, list available workgroups for the account, get the specified data catalog, list tags associated with an Athena workgroup or data catalog resource, and list the data catalogs in the current AWS account\.  | May 31, 2022 | 
