# Operational Best Practices for Canadian Centre for Cyber Security \(CCCS\) Medium Cloud Control Profile<a name="operational-best-practices-for-cccs_medium"></a>
