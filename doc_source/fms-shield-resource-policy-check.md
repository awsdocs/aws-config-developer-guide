...
**AWS Region:** All supported AWS regions except China \(Beijing\), Asia Pacific \(Jakarta\), Middle East \(UAE\), Europe \(Spain\), China \(Ningxia\), Europe \(Zurich\) Region
...
## AWS CloudFormation template<a name="w2aac12c31c27b9d307c15"></a>
