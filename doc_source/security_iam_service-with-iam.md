# How AWS Config works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for AWS Config<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for AWS Config<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within AWS Config<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for AWS Config<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for AWS Config<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for AWS Config<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in AWS Config<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with AWS Config<a name="security_iam_service-with-iam-tags"></a>
...
## Using temporary credentials with AWS Config<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for AWS Config<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for AWS Config<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for AWS Config<a name="security_iam_service-with-iam-roles-service-linked"></a>
