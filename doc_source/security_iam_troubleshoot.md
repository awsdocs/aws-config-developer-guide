# Troubleshooting AWS Config identity and access<a name="security_iam_troubleshoot"></a>
...
## I am not authorized to perform an action in AWS Config<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I want to allow people outside of my AWS account to access my AWS Config resources<a name="security_iam_troubleshoot-cross-account-access"></a>
