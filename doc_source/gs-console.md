...
1. 
   ...
   If you are setting up AWS Config in a region that supports rules, choose **Next**\. See [Using AWS Config Rules with the Console](setting-up-aws-config-rules-with-console.md)\. 
